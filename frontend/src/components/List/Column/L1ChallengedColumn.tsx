...
import icon from '../../../icons/challenged.svg';

export class L1ChallengedColumn extends React.Component<ColumnProps> {
  public static readonly label = 'Layer1 Challenged Block';
  public static readonly icon = icon;
  public static readonly width = 154;
  public static readonly setting = 'l1challenged';
