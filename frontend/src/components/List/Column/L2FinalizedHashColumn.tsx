...
import icon from '../../../icons/l2-blockhash.svg';

export class L2FinalizedHashColumn extends React.Component<ColumnProps> {
  public static readonly label = 'Layer2 Finalized Block Hash';
  public static readonly icon = icon;
  public static readonly width = 154;
  public static readonly setting = 'l2finalizedhash';
