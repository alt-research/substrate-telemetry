...
import icon from '../../../icons/blockchain.svg';

export class VerifiedBlockNumberColumn extends React.Component<ColumnProps> {
  public static readonly label = 'Verified Block Number';
  public static readonly icon = icon;
  public static readonly width = 16;
  public static readonly setting = 'verifiedblocknumber';
