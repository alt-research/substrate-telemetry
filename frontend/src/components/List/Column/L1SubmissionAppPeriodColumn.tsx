...
import icon from '../../../icons/l1-submision-app-period.svg';

export class L1SubmissionAppPeriodColumn extends React.Component<ColumnProps> {
  public static readonly label = 'Layer1 submission App Period';
  public static readonly icon = icon;
  public static readonly width = 154;
  public static readonly setting = 'l1SubmissionAppPeriod';
