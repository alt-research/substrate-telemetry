...
import icon from '../../../icons/blockhash.svg';

export class VerifiedBlockHashColumn extends React.Component<ColumnProps> {
  public static readonly label = 'Verified Block Hash';
  public static readonly icon = icon;
  public static readonly width = 16;
  public static readonly setting = 'verifiedblockhash';
