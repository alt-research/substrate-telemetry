...
import icon from '../../../icons/submitted.svg';

export class L1SubmittedColumn extends React.Component<ColumnProps> {
  public static readonly label = 'Layer1 Submitted Block';
  public static readonly icon = icon;
  public static readonly width = 154;
  public static readonly setting = 'l1submitted';
