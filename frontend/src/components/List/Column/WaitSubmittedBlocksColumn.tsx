...
import icon from '../../../icons/wait-submitted.svg';

export class WaitSubmittedBlocksColumn extends React.Component<ColumnProps> {
  public static readonly label = 'Wait Submitted Blocks';
  public static readonly icon = icon;
  public static readonly width = 16;
  public static readonly setting = 'waitsubmittedblocks';
