  ...
  constructor(props: Record<string, unknown>) {
    ...
    this.settings = new PersistentObject(
      'settings',
      {
        ...
        blocklasttime: true,
        uptime: true,
        l1finalizedblock: true,
        l1finalizedhash: true,
        l2finalizedblock: true,
        l2finalizedhash: true,
        l1submitted: true,
        l1challenged: true,
        verifiedblockhash: true,
        verifiedblocknumber: true,
        waitsubmittedblocks: true,
        l1SubmissionAppPeriod: true,
        l1finishedchallengeAppPeriod: true,
        nodeuptime: true,
      },
      (settings) => {
